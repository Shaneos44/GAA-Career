...
//
// Produces:
//   gaa-career.html   standalone single file — double-click to play
...
`;
write(path.join(DIR, "gaa-career.html"), standalone);
...
const CACHE = "gaa-career-${version}";
const ASSETS = [
...
console.log(`gaa-career.html          ${kb(standalone)}`);
